...
```bash
NLP/
├── 01_Text_Preprocessing.md    # Tiền xử lý văn bản
├── 02_Vectorization_Static.md  # Vector hóa văn bản
├── 03_Sequence_Models.md       # Mô hình chuỗi: RNN, LSTM, GRU (Cơ sở của dịch thuật cũ)
├── 04_Transformer_BERT.md      # Cách mạng Transformer: Attention, BERT, RoBERTa (Hiểu ngữ cảnh)
