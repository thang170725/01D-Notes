...
- [Computer-Networking Introduction (Thuật ngữ về mạng máy tính)](#computer-networking-introduction-thuật-ngữ-về-mạng-máy-tính)
---
# Directory Structure
Computer-Networking/                                                  ```mình dùng thư mục này là second brain```    
├── [VPN](VPN.md)                          ```mình dùng thư mục này để xem kiến thức về VPN```   
