...
├── API.md                         # mình dùng file này để thao tác với API 
├── Arrays.md                      # mình dùng file này để thao tác với mảng
├── Base.md                        # mình dùng file này để xem kiến thức cơ bản và các tiện ích
├── DataType_Variable_Operator.md  # mình dùng file này để thao tác kiểu dữ liệu, biến, toán tử
├── Function.md                    # mình dùng file này để thao tác với hàm
├── IO.md                          # mình dùng file này để nhập, xuất
├── JSON.md                        # mình dùng file này để thao tác với JSON
├── Loop_If_Else.md                # mình dùng file này để thao tác điều kiên và lặp
├── Math.md                        # mình dùng file này để thao tác với Object Math 
├── Number.md                      # mình dùng file này để xử lý số
├── Practices.md                   # mình dùng file này để xem code mẫu, bài tập
├── Set_map.md                     # mình dùng file này để thao tác với set, map
