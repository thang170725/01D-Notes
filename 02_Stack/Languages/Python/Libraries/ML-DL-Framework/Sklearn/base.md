...
- [dữ liệu gốc dạng chuỗi](#dữ-liệu-gốc-dạng-chuỗi-2)
- [tạo LabelEncoder](#tạo-labelencoder-2)
- [mã hóa từ chuỗi sang số](#mã-hóa-từ-chuỗi-sang-số-2)
- [giải mã](#giải-mã)
- [X là chiều cao, y là cân nặng](#x-là-chiều-cao-y-là-cân-nặng)
- [chia dữ liệu thành 70% train, 30% test](#chia-dữ-liệu-thành-70-train-30-test)
- [Data](#data)
- [Build tree](#build-tree)
- [Predict](#predict)
- [(0: xanh, nhỏ) (1: đỏ, to)](#0-xanh-nhỏ-1-đỏ-to)
- [X: mỗi hàng là 1 email, mỗi cột là đặc trưng: "free", "win", "click"](#x-mỗi-hàng-là-1-email-mỗi-cột-là-đặc-trưng-free-win-click)
- [Nhãn: 1 = spam, 0 = not spam](#nhãn-1--spam-0--not-spam)
- [Huấn luyện](#huấn-luyện)
- [Dự đoán trên tập huấn luyện](#dự-đoán-trên-tập-huấn-luyện)
- [Độ chính xác](#độ-chính-xác)
- [Ví dụ: Email mới có "free" và "click", không có "win"](#ví-dụ-email-mới-có-free-và-click-không-có-win)
...
```bash
Sklearn/
├── 01_Data_Preprocessing.md    # Tiền xử lý: Scaler, Imputer, LabelEncoder
├── 02_Feature_Selection.md     # Chọn lọc đặc trưng: PCA, SelectKBest, VarianceThreshold
├── 03_Supervised_Learning.md   # Học có giám sát: Linear, Trees, SVM, KNN, Ensemble
├── 04_Unsupervised_Learning.md # Học không giám sát: Clustering (K-Means), Anomaly Detection
├── 05_Model_Evaluation.md      # Đánh giá: Cross-validation, Confusion Matrix, R2, MSE
└── 06_Model_Selection_Tuning.md # Tối ưu: GridSearchCV, RandomizedSearchCV, Pipelines
```
Sklearn
feature_extraction
text
