...
---
# Directory Structure
Tools/                                                  ```mình dùng thư mục này là second brain```    
├── [Apache Airflow](Apache-Airflow.md)                 ```mình dùng thư mục này để xem giới thiệu về các công ty công nghệ (các dịch vụ của họ)```   
├── [HubSpot](HubSpot.md)                               ```mình dùng thư mục này để xem các lĩnh vực trong ngành IT```   
