  ...
  - [minidom](#minidom)
    - [parse (Đọc file XML)](#parse-đọc-file-xml)
      ...
      - [getElementsByTagName()](#getelementsbytagname)
        - [.getAttribute() (lấy thuộc tính của thẻ)](#getattribute-lấy-thuộc-tính-của-thẻ)
        - [.firstChild](#firstchild)
          - [.data](#data)
      - [.createElement() (tạo thẻ mới trong cây XML)](#createelement-tạo-thẻ-mới-trong-cây-xml)
        - [.tagName](#tagname-1)
      - [.createTextNode() (tạo dữ liệu)](#createtextnode-tạo-dữ-liệu)
        - [.setAttribute()](#setattribute)
        - [.appendChild() (ghép các node lại với nhau)](#appendchild-ghép-các-node-lại-với-nhau)
