- [Transformers Introduction (Nó giúp bạn sử dụng các mô hình Transformer một cách đơn giản)](#transformers-introduction-nó-giúp-bạn-sử-dụng-các-mô-hình-transformer-một-cách-đơn-giản)
...
---
# Transformers Introduction (Nó giúp bạn sử dụng các mô hình Transformer một cách đơn giản)
```bash
...
```bash
1. Mô hình sinh văn bản (Text Generation): Đây là nhóm LLM mà mọi người thường nhắc đến.
    Ứng dụng
        - Chatbot
        - AI Assistant
        - Viết code
...
2. Mô hình Encoder (Embedding & Hiểu văn bản): Nhóm này không giỏi viết mà giỏi hiểu.
    Ứng dụng
        - Embedding
        - Semantic Search
        - RAG
...
3. Text Classification: Dùng để phân loại.
    Ví dụ
        - Spam
        - Toxic
        - Positive
...
4. Token Classification: Phân loại từng từ.
...
5. Question Answering: Cho Context + Question.
    Ví dụ
        Context: Việt Nam có thủ đô là Hà Nội.
        Question: Thủ đô Việt Nam là gì? -> Hà Nội
...
8. Fill Mask: Điền từ bị thiếu.
    Ví dụ: I love [MASK]. -> Python
...
9. Sentence Embedding: Sinh vector.
    Ứng dụng
        - RAG
        - Search
        - Recommendation
...
11. Object Detection: Tìm vật thể.
    Ví dụ: Ảnh -> Người -> Bounding Box
...
12. Image Segmentation: Tách từng pixel.
    Ví dụ
        - Người
        - Xe
        - Cây
...
13. Image Captioning: Sinh mô tả ảnh.
    Ví dụ: Ảnh -> "A dog running in a park."
...
14. Visual Question Answering (VQA)
    Ví dụ: Ảnh + "Có bao nhiêu người?" -> 3 người
