...
- [Transform (Xử lý biến dạng cấu trúc mảng)](#transform-xử-lý-biến-dạng-cấu-trúc-mảng)
  - [.append()](#append)
  - [.extend() (dùng để thêm tất cả phần tử của một iterable vào cuối list hiện tại)](#extend-dùng-để-thêm-tất-cả-phần-tử-của-một-iterable-vào-cuối-list-hiện-tại)
---
...
## .append()
## .extend() (dùng để thêm tất cả phần tử của một iterable vào cuối list hiện tại)
**Syn**
```bash
...
print(a) # [1, 2, 'a', 'b', 'c'] - Vì string là một iterable nên từng ký tự được thêm vào.
```
**Ex3: Trong vòng lặp**
```python
result = []
...
print(a) # [1, 2, [3, 4]] - b được thêm như một phần tử.
```
**extend()**
```python
a = [1, 2]
...
print(a) # [1, 2, 3, 4] - Các phần tử của b được thêm vào a.
```
