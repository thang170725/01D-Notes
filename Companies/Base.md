...
- [Companies Introduction (thư mục này chuyên nghiên cứu về các công ty công nghệ trên thế giới)](#companies-introduction-thư-mục-này-chuyên-nghiên-cứu-về-các-công-ty-công-nghệ-trên-thế-giới)
- [Ask](#ask)
...
```bash
1. Ta cần một việc làm -> làm trong các công ty công nghệ -> hiểu được domain của các công ty công nghệ đó đang làm
```